...
class Name extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      active: localStorage.getItem(this.props.employee.id) ? true : false,
    };
  }
  ...
  activate(x) {
    ...
    x
      ? localStorage.setItem(this.props.employee.id, x)
      : localStorage.removeItem(this.props.employee.id);
    this.props.onclick();
  }
